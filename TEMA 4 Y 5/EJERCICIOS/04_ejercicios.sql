...
FROM USER_CONSTRAINTS WHERE UPPER(TABLE_NAME) IN ('TIENDAS','FABRICANTES','ARTICULOS','VENTAS','PEDIDOS');
...
ALTER TABLE TIENDAS ADD
(
    CONSTRAINT TIE_PRO_TOL_CK CHECK (UPPER(PROVINCIA) NOT LIKE('TOLEDO'))
);
